      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-100 dark:from-gray-900 dark:to-gray-800 transition-colors">
        ...
        <div className="max-w-4xl mx-auto px-4 py-4 space-y-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-colors">
            ...
            <MessageZone location="music_section" className="mt-3" />
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-colors">
            ...
            <MessageZone location="settings_section" className="mt-6" />
          ...
          <button
            ...
            disabled={isLoading || slideshowPreviewImages.length === 0 || !slideshowName.trim()}
